...
public class sportmanagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("SPORT MANAGEMENT");
        ...
        jTextArea1.setText("Sport management is the field of business dealing with sports and recreation. Sports management involves any combination of skills that correspond with planning, organizing, directing, controlling, budgeting, leading, or evaluating of any organization or business within the sports field.");
        ...
        jLabel22.setText("UDEMY");

        jLabel10.setIcon(new javax.swing.ImageIcon("C:\\Users\\Admin\\Desktop\\collegedunia.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      Desktop desk = Desktop.getDesktop();
        try {
            desk.browse(new URI("https://collegedunia.com/courses/sports-management"));
        } catch (URISyntaxException ex) {
            Logger.getLogger(sportmanagement.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Desktop desk = Desktop.getDesktop();
        try {
            desk.browse(new URI("https://www.udemy.com/course/sports-management-the-essentials-course/"));
        } catch (URISyntaxException ex) {
            Logger.getLogger(sportmanagement.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
            Logger.getLogger(sportmanagement.class.getName()).log(Level.SEVERE, null, ex);
